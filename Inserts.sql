...
values ('VerUsuario','Permiso',1),('AgregarUsuario','Permiso',1),('GestionarUsuario','GrupoPermiso',1),('VerCliente','Permiso',1),('VerPermiso','Permiso',1),('VerProducto','Permiso',1),('VerPresupuesto','Permiso',1),('VerComprobante','Permiso',1),('VerUsuarioPermiso','GrupoPermiso',1),('VerPresupuestoComprobante','GrupoPermiso',1)
go
...
values (1,1),(1,4),(1,5),(1,6),(1,7),(1,8),(2,9),(2,6)
go

insert into GrupoPermiso(IdGrupoPermiso,NombreGrupo)
values (3,'GestionarUsuario'),(9,'GrupoPrueba'),(10,'GrupoPrueba2')
go

insert into GrupoPermisoComponente(IdGrupoPermiso,IdComponente)
values (3,1),(3,2),(9,1),(9,5),(9,10),(10,7),(10,8)
go
